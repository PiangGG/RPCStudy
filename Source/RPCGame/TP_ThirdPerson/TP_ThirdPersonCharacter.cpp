...
#include "RPCGame/RPCActor.h"
#include "RPCGame/RPCHelper.h"
...
ATP_ThirdPersonCharacter::ATP_ThirdPersonCharacter()
{
	...
	ConstructorHelpers::FClassFinder<UAnimInstance> AnimBlueprint(TEXT("AnimBlueprint'/Game/Mannequin/Animations/ThirdPerson_AnimBP.ThirdPerson_AnimBP_C'"));
	GetMesh()->AnimClass=AnimBlueprint.Class;
}
...
void ATP_ThirdPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Jump", IE_Pressed, this, &ATP_ThirdPersonCharacter::SpaceBarNetMulticast);
...
void ATP_ThirdPersonCharacter::BeginPlay()
{
	...
	UGameplayStatics::GetAllActorsOfClass(GetWorld(),ARPCActor::StaticClass(),ActorArray);
	//DDH::Debug()<<"RPCActor Num-->"<<ActorArray.Num()<<DDH::End();
}
...
void ATP_ThirdPersonCharacter::SpaceBarNetMulticast_Implementation()
{
	UClass* FireEffectClass=LoadClass<AActor>(NULL,TEXT("Blueprint'/Game/Blueprint/UnReplicatedFire.UnReplicatedFire_C'"));
